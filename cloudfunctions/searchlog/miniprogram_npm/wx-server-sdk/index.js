...
__DEFINE__(1600243330058, function(require, module, exports) {
module.exports =
...
class Cloud {
    constructor(options) {
        ...
        // internal
        this.wxLocalSCFEndLoadTimes = Number(process.env.WX_LOCAL_SCF_HOTRELOAD_TIMES);
        ...
        if (options) {
            ...
            if (options.appid || options.resourceAppid) {
                if (!options.appid || !options.resourceAppid) {
                    throw new Error(`appid and resourceAppid must be both present or absent`);
                }
            }
        }
        else {
    ...
    async instanceInit() {
        ...
        if (this.cloudInstanceOptions.appid && this.cloudInstanceOptions.resourceAppid) {
    ...
    autoRefreshProviderInstanceConfig() {
        setTimeout(() => {
            const newPartialConfig = this.getWXLocalSCFConfig();
            for (const key in newPartialConfig) {
                this.instance.config[key] = newPartialConfig[key];
            }
            if (!process.env.WX_LOCAL_SCF_HOTRELOAD_TIMES /** fallback */ || this.wxLocalSCFEndLoadTimes === Number(process.env.WX_LOCAL_SCF_HOTRELOAD_TIMES)) {
                this.autoRefreshProviderInstanceConfig();
            }
        }, 3 * 60 * 1000);
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.returnAsFinalCloudSDKError = exports.returnAsCloudSDKError = exports.isSDKError = exports.createError = exports.CloudSDKError = void 0;
const type_1 = __webpack_require__(/*! ./type */ "./src/utils/type.ts");
...
/******/ });
}, function(modId) {var map = {"./package.json":1600243330059}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1600243330059, function(require, module, exports) {
module.exports = {
  "name": "wx-server-sdk",
  "version": "2.3.0",
  ...
  "__npminstall_done": "Tue Sep 15 2020 22:11:45 GMT+0800 (GMT+08:00)",
  "_from": "wx-server-sdk@2.3.0",
  "_resolved": "https://registry.npm.taobao.org/wx-server-sdk/download/wx-server-sdk-2.3.0.tgz"
}
}, function(modId) { var map = {}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1600243330058);
})()
